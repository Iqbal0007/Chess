...
public class Queen extends Piece {
        ...
        for (final int candidateCoordinateOffset : CANDIDATE_MOVE_VECTOR_COORDINATES) {
            ...
            while (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                if (isFirstColumExclusion(candidateDestinationCoordinate, candidateCoordinateOffset) ||
                        isEightColumnExcclusion(candidateDestinationCoordinate, candidateCoordinateOffset)) {
                    break;
                }
    ...
    private static boolean isEightColumnExcclusion(final int currentPosition, final int candidateOffset) {
